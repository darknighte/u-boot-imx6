...
#define CONFIG_EXTRA_ENV_SETTINGS_BD_SL \
	...
	"sysdtrace=systemd.trace=\0" \ 
	"sysdtraceargs=setenv trace init=/home/root/systemd-trace.sh ${sysdtrace}\0" \
	"sysdtracecmd=run sysdtraceargs; run bootcmd\0" \
	"mmcdev="__stringify(CONFIG_SYS_MMC_ENV_DEV)"\0" \
	"mmcpart=1\0" \
	"mmcroot=root=/dev/mmcblk3p2 rootwait rw\0" \
...
#define CONFIG_EXTRA_ENV_SETTINGS_TRACING \
	...
	"tracesave=print profoffset; mmc dev ${mmcdev}; mmc write ${profbase} 0x4000 0x8000\0" \
